...
export const SessionPanel: React.FC = () => {
  const { loadSessions, deleteSession: deleteFromStore } = useSessionStore();
  ...
  const deleteSessionById = useMapStore((s) => s.deleteSessionById);
  const deleteCurrentSession = useMapStore((s) => s.deleteCurrentSession);
  ...
  useEffect(() => { loadSessions(); }, [activeSession?.id, activeSession?.stats.totalNodes, loadSessions]);
            ...
            {filteredSessions.map((s) => {
              ...
              return (
                <div
                  ...
                  onClick={() => {
                    if (!isEditing && !isConfirmingDelete) loadSession(s.id);
                  }}
                >
                  {/* Delete Confirmation */}
                  {isConfirmingDelete ? (
                    <div className="space-y-2" onClick={(e) => e.stopPropagation()}>
                      ...
                      <p className="text-2xs text-surface-500">
                        This will permanently delete {s.nodeCount} pages. Cannot be undone.
                      </p>
                    ...
                    <>
                      ...
                      {!isEditing && (
                        <div className="flex items-center gap-3 text-2xs text-surface-500">
                          ...
                          <span className="flex items-center gap-1">
                            <GitBranch className="w-3 h-3" /> Depth {s.maxDepth}
                          </span>
                          <span>
